...
if (isset($_POST['client']) && !empty($_POST['client'])) {
  ...
  echo "<table  width='100%'><tr> <td align='center'><h1>Bill Statement</h1></td></tr><tr><td align='center'> Client Name: ". get_customer_name($connect,$client)."</td></tr>";
}
  ...
  <table class="table myTable" width="100%" style="font-size: 11px;">
    <thead class="bg-sky">
      <tr>
        ...
        <th style="width:22%;">Previous Bill No</th>
        <th style="width:15%;">Port</th>
        <th style="width:13%;"> Total Bill</th>
      </tr>
    </thead>
    <tbody>
<?php 
...
$profit = 0;
  foreach ($result1 as $row) {
    ...
    $profit += $row['bill_total']-$row['expenses_total'];
?>
        <tr>
          ...
          <td><?php echo get_port_name($connect, $row['port']); ?></td>
