...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <a href="ledgerentry.php" class="btn btn-block btn-primary"><i class="fa fa-undo"></i> Back to Ledger Entry</a>
        </ol>
    </section>
    <!-- Main content -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" name="ledger_date" id="ledger_date" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
document.getElementById("demo").innerHTML = "<b style='color:red;'>bill_amount field can not be empty and Charecter</b>";
} else if (bill_amount < 1) {
// ////alert("bill_amount & Price should be Number and Not Empty");
document.getElementById("demo").innerHTML = "<b style='color:red;'>bill_amount field can not be less than One</b>";
} else {
//alert ()
        ...
        .append($('<td style="display:none;">').append(payment_type))
            .append($('<td>').append(payment_type_name))
                .append($('<td>').append(bill_name))
                    ...
                    .append($('<td style="display:none;">').append(remarks))
