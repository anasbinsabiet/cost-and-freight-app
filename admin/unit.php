...
<div class="content-wrapper">
  <section class="content-header">
    <h4>Unit List</h4>
    <ol class="breadcrumb">
      <a href="unit_add.php" class="btn btn-block btn-primary"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Unit</a>
    </ol>
  </section>
  <!-- Main content -->
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-success btn-xs"
                                               href="unit_edit.php?id=<?php echo $row["unit_id"]; ?>">Edit</a>
                                            <button type="button" name="delete" id="<?php echo $row["unit_id"] ?>"
                                                    class="btn btn-danger btn-xs delete"
                                                    data-status="<?php echo $row["unit_delete"] ?>">Delete
                                            </button>
                                        </td>
                                    </tr>
                                    <?php
