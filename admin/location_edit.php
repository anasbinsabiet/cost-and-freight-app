...
<div class="content-wrapper">
    ...
    <section class="content">
            <?php
            $id = $_GET['id'];
            $statement = $connect->prepare("SELECT * FROM location WHERE location_id = '$id' ");
            $statement->execute();
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                            ...
                            <form id="addlocation" action="" method="">
                                <input type="hidden" name="location_id" id="location_id" value="<?php echo $row['location_id']; ?> "/>
                                <div class="form-group">
                                    <label for="location_name">Location Name</label>
                                    <input type="text" name="location_name" id="location_name" class="form-control" value="<?php echo $row['location_name']; ?> "/>
                                </div>
