...
<div class="content-wrapper">
  <section class="content-header">
    <h4>User List</h4>
    <ol class="breadcrumb">
      <a href="user_add.php" class="btn btn-block btn-primary"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add User</a>
    </ol>
  </section>
  <!-- Main content -->
                            ...
                            <table id="myTable" class="table table-striped table-bordered">
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-1"><?php echo $row['user_role']; ?></td>
                                        <td><?php echo $user_status; ?></td>
                                        <td><a class="btn btn-success btn-xs"
                                               href="user_edit.php?id=<?php echo $row["user_id"]; ?>">Edit</a>
                                            <button type="button" name="delete" id="<?php echo $row["user_id"] ?>"
                                                    class="btn btn-danger btn-xs delete"
                                                    data-status="<?php echo $row["user_delete"] ?>">Delete
                                            </button>
                                        </td>
                                    </tr>
                                    <?php
